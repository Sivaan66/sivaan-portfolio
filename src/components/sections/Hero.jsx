...
// Evidence-based metrics from the current portfolio/project data.
const KPI_CARDS = [
  ["Featured projects", "4", "Analytics + engineering", BriefcaseBusiness],
  ["Customers analyzed", "5,942", "Online Retail analysis", Database],
  ["Revenue analyzed", "£16.29M", "Online Retail analysis", BarChart3],
  ["High Value revenue", "74.15%", "From 21.88% of customers", Layers3],
];

const EVIDENCE = [
  ["Customer Analytics", "Cohort retention · RFM · product value · Power BI", "Online Retail"],
  ["Risk Analytics", "Recall-first classification · SHAP · missed-case analysis", "Delinquency"],
  ["Data Engineering", "Incremental ETL · validation · idempotent loading", "Flood monitoring"],
  ["Optimization", "FOPID design · M-AHA parameter search · simulation", "Cruise control"],
];

const STACK = [
  ["Python", "Analysis / ML / ETL"],
  ["Pandas", "Cleaning / metrics"],
      ...
      <div className="flex items-center justify-between border-b border-surface-border pb-3 mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-surface-border bg-surface-panel px-2.5 py-1.5 font-mono text-[10px] text-ink-muted hover:text-ink transition-colors"
          >
      ...
      <div className="grid xl:grid-cols-[1.5fr_1fr] gap-3">
        <div className="glass-panel p-5 sm:p-6 min-h-[225px] flex flex-col justify-between overflow-hidden relative">
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-3 font-mono text-[10px] text-ink-faint">
            ...
            {showOutput && (
              <div className="animate-fade-up">
                ...
                <p className="mt-3 max-w-xl text-xs leading-5 text-ink-muted">
                  Analytics, machine learning, and automation built around real business questions.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {KPI_CARDS.map(([label, value, detail, Icon]) => (
            <div key={label} className="glass-panel p-3.5 flex items-center justify-between min-h-[106px]">
              <div>
                <p className="font-mono text-[8px] uppercase tracking-widest text-ink-faint mb-1.5">{label}</p>
